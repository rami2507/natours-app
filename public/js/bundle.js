    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          ...
          return (0, _axios.default)({
            method: "PATCH",
            url: type === "data" ? "http://127.0.0.1:3000/api/v2/users/updateMe" : "http://127.0.0.1:3000/api/v2/users/updateMyPassword",
            data: data
          });
        ...
        case 4:
          ...
          if (res.data.status === "success") {
            (0, _alerts.showAlert)("success", "".concat(type, " has been updated successfuly"));
          }
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        ...
        case 9:
          ...
          (0, _alerts.showAlert)("error", "Error. Try again later");
